            ...
            <div class="row product-detail ">
                ...
                <div class="product_info col-md-6">
                    ...
                    <form method="POST" action="#">
                        ...
                        <a href="{{route('get.add.product',$products->id)}}"><button type="button" class="btn btn-default btn-lg btn-block btn-add" style="width:300px;"  align=center>Add To Cart</button></a></p>
                    </form>
